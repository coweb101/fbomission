function error = probfb_fun_model9b(params,sub_choice,sub_fb,sub_not_choice,ntrials, sub_stimuli, sub_feedback_type)

% Separate learning rates for learning contex and stimulus reward probability
    ...
    if isnan(sub_choice(i)) || isnan(sub_fb(i))
        ...
        if sub_stimuli(i) == 1 | sub_stimuli(i) == 2 % if current stimulus is 90%
            ...
            % omitted & it is negative --> get reward context
                ...
                Q(unchosen_index) = Q(unchosen_index) + alpha_90_getreward*PE_u;
            ...
            % omitted & it is positive --> avoid loss context   
                ...
                Q(unchosen_index) = Q(unchosen_index) + alpha_90_avoidloss*PE_u;
        ...
        elseif sub_stimuli(i) == 3 | sub_stimuli(i) == 4 % 70%
            ...
            % omitted & it is negative --> get reward context
                ...
                Q(unchosen_index) = Q(unchosen_index) + alpha_70_getreward*PE_u;
            ...
            % omitted & it is positive --> avoid loss context 
                ...
                Q(unchosen_index) = Q(unchosen_index) + alpha_70_avoidloss*PE_u;
        ...
        elseif sub_stimuli(i) == 5 | sub_stimuli(i) == 6 % 50%
            ...
            % omitted & it is negative --> get reward context
                ...
                Q(unchosen_index) = Q(unchosen_index) + alpha_50_getreward*PE_u;
            ...
            % omitted & it is positive --> avoid loss context 
                ...
                Q(unchosen_index) = Q(unchosen_index) + alpha_50_avoidloss*PE_u;
