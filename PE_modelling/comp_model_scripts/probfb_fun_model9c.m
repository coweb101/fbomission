function error = probfb_fun_model9c(params,sub_choice,sub_fb,sub_not_choice,ntrials, sub_stimuli, sub_feedback_type)

% Separate learning rates for context, stimulus reward probability, choice
...
alpha_90_getreward_unchosen = params(7);
alpha_70_getreward_unchosen = params(8);
alpha_50_getreward_unchosen = params(9);
alpha_90_avoidloss_unchosen = params(10);
alpha_70_avoidloss_unchosen = params(11);
alpha_50_avoidloss_unchosen = params(12);
beta = params(13);
    ...
    if isnan(sub_choice(i)) || isnan(sub_fb(i))
        ...
        if sub_stimuli(i) == 1 | sub_stimuli(i) == 2 % if current stimulus is 90%
            ...
            % omitted & it is negative --> get reward context
                ...
                Q(unchosen_index) = Q(unchosen_index) + alpha_90_getreward_unchosen*PE_u;
            ...
            % omitted & it is positive --> avoid loss context   
                ...
                Q(unchosen_index) = Q(unchosen_index) + alpha_90_avoidloss_unchosen*PE_u;
        ...
        elseif sub_stimuli(i) == 3 | sub_stimuli(i) == 4 % 70%
            ...
            % omitted & it is negative --> get reward context
                ...
                Q(unchosen_index) = Q(unchosen_index) + alpha_70_getreward_unchosen*PE_u;
            ...
            % omitted & it is positive --> avoid loss context 
                ...
                Q(unchosen_index) = Q(unchosen_index) + alpha_70_avoidloss_unchosen*PE_u;
        ...
        elseif sub_stimuli(i) == 5 | sub_stimuli(i) == 6 % 50%
            ...
            % omitted & it is negative --> get reward context
                ...
                Q(unchosen_index) = Q(unchosen_index) + alpha_50_getreward_unchosen*PE_u;
            ...
            % omitted & it is positive --> avoid loss context 
                ...
                Q(unchosen_index) = Q(unchosen_index) + alpha_50_avoidloss_unchosen*PE_u;
