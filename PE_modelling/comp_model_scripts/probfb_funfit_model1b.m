% Model 1b: Fit model with one global learning rate & an exploration
% parameter; update of chosen and unchosen action value
...
for i = 1:nsubs
    ...
    for j = 1:niter
        ...
        % call fmincon to minimize output of function: probfb_fun_model1b
        [params, LL] = fmincon(@probfb_fun_model1b,params,[],[],[],[],LB,UB,[],options,......
