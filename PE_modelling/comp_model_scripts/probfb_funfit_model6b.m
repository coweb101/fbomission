% Model 6b: Fit rl model with one learning  rate per stimulus reward 
% probabilities & update of chosen and unchosen action value
...
for i = 1:nsubs
    ...
    for j = 1:niter
        ...
        [params, LL] = fmincon(@probfb_fun_model6b,params,[],[],[],[],LB,UB,[],options,......
