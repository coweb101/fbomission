function error = probfb_fun_model6(params,sub_choice,sub_fb,sub_not_choice,ntrials, sub_stimuli)

% One learning rate regardless of FB valence but separately for
% stimuli/action reward probability
