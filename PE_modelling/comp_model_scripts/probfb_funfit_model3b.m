% Model 3b: Fit rl model with two global learning rate across all 6 stimuli 
% and across feedback valence and context, however separately for presented
% and omitted feedback 
% plus update of unchosen action value
...
for i = 1:nsubs
    ...
    for j = 1:niter
        ...
        params = [alpha_presented, alpha_omitted, beta];
        ...
        [params, LL] = fmincon(@probfb_fun_model3b,params,[],[],[],[],LB,UB,[],options,......
