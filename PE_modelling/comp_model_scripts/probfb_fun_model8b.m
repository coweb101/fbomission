function error = probfb_fun_model8b(params,sub_choice,sub_fb,sub_not_choice,ntrials, sub_stimuli, sub_feedback_type)

% Separate learning rates for FB appearance and stimulus reward probability
    ...
    if isnan(sub_choice(i)) || isnan(sub_fb(i))
        ...
        if sub_stimuli(i) == 1 | sub_stimuli(i) == 2 % if current stimulus is 90%
            ...
            if sub_feedback_type(i) == 1 % if fb is presented
                ...
                Q(unchosen_index) = Q(unchosen_index) + alpha_90_presented*PE_u;
            elseif sub_feedback_type(i) == 0 % if fb is omitted
                
                Q(chosen_index) = Q(chosen_index) + alpha_90_omitted*PE_c;
                Q(unchosen_index) = Q(unchosen_index) + alpha_90_omitted*PE_u;
            end
        ...
        elseif sub_stimuli(i) == 3 | sub_stimuli(i) == 4 % 70%
            ...
            if sub_feedback_type(i) == 1 % if fb is presented
                ...
                Q(unchosen_index) = Q(unchosen_index) + alpha_70_presented*PE_u;
            elseif sub_feedback_type(i) == 0 % if fb is omitted
                
                Q(chosen_index) = Q(chosen_index) + alpha_70_omitted*PE_c;
                Q(unchosen_index) = Q(unchosen_index) + alpha_70_omitted*PE_u;
            end
        ...
        elseif sub_stimuli(i) == 5 | sub_stimuli(i) == 6 % 50%
            ...
            if sub_feedback_type(i) == 1 % if fb is presented
                ...
                Q(unchosen_index) = Q(unchosen_index) + alpha_50_presented*PE_u;
            
            elseif sub_feedback_type(i) == 0 % if fb is omitted
                
                Q(chosen_index) = Q(chosen_index) + alpha_50_omitted*PE_c;
                Q(unchosen_index) = Q(unchosen_index) + alpha_50_omitted*PE_u;
