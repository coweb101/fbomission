function error = probfb_fun_model5(params,sub_choice,sub_fb,sub_not_choice,ntrials, sub_stimuli, sub_feedback_type)

% Separate learning rates for valence + appearance (i.e. each possible 
% feedback type
% Only chosen action is updated (but not unchosen)
