function error = probfb_fun_model10abc(params,sub_choice,sub_fb,sub_not_choice,ntrials, sub_stimuli, sub_feedback_type)

% Separate learning rates for reward probability, valence, appearance,
% choice, and expoential decay of learning rates
% (+ unchosen update)
...
beta = params(25);
lambda = params(26); % half-life decay parameter
...
alpha_90_presented_pos_unchosen_initial = params(13);
alpha_70_presented_pos_unchosen_initial = params(14);
alpha_50_presented_pos_unchosen_initial = params(15);
alpha_90_omitted_pos_unchosen_initial = params(16);
alpha_70_omitted_pos_unchosen_initial = params(17);
alpha_50_omitted_pos_unchosen_initial = params(18);
alpha_90_presented_neg_unchosen_initial = params(19);
alpha_70_presented_neg_unchosen_initial = params(20);
alpha_50_presented_neg_unchosen_initial = params(21);
alpha_90_omitted_neg_unchosen_initial = params(22);
alpha_70_omitted_neg_unchosen_initial = params(23);
alpha_50_omitted_neg_unchosen_initial = params(24);  
    ...
    if isnan(sub_choice(i)) || isnan(sub_fb(i))
        ...
        if sub_stimuli(i) == 1 | sub_stimuli(i) == 2 % if current stimulus is 90%
            ...
            if sub_feedback_type(i) == 1 & sub_fb(i) == 1 
                ...
                alpha_90_presented_pos_unchosen = alpha_90_presented_pos_unchosen_initial/2^((i-1)/lambda);
                Q(unchosen_index) = Q(unchosen_index) + alpha_90_presented_pos_unchosen*PE_u;
            ...
            % else if feedback is omitted and feedback is negative
                ...
                alpha_90_omitted_neg_unchosen = alpha_90_omitted_neg_unchosen_initial/2^((i-1)/lambda);
                Q(unchosen_index) = Q(unchosen_index) + alpha_90_omitted_neg_unchosen*PE_u;
            ...
            % else if feedback is omitted and feedback is positive
                ...
                alpha_90_omitted_pos_unchosen = alpha_90_omitted_pos_unchosen_initial/2^((i-1)/lambda);
                Q(unchosen_index) = Q(unchosen_index)+ alpha_90_omitted_pos_unchosen*PE_u;
            ...
            % else if feedback is presented and feedback is negative
                ...
                alpha_90_presented_neg_unchosen = alpha_90_presented_neg_unchosen_initial/2^((i-1)/lambda);
                Q(unchosen_index) = Q(unchosen_index)+ alpha_90_presented_neg_unchosen*PE_u;
        ...
        elseif sub_stimuli(i) == 3 | sub_stimuli(i) == 4 % 70%
            ...
            if sub_feedback_type(i) == 1 & sub_fb(i) == 1 
                ...
                alpha_70_presented_pos_unchosen = alpha_70_presented_pos_unchosen_initial/2^((i-1)/lambda);
                Q(unchosen_index) = Q(unchosen_index) + alpha_70_presented_pos_unchosen*PE_u;
            ...
            % else if feedback is omitted and feedback is negative
                ...
                alpha_70_omitted_neg_unchosen = alpha_70_omitted_neg_unchosen_initial/2^((i-1)/lambda);
                Q(unchosen_index) = Q(unchosen_index) + alpha_70_omitted_neg_unchosen*PE_u; 
            ...
            % else if feedback is omitted and feedback is positive
                ...
                alpha_70_omitted_pos_unchosen = alpha_70_omitted_pos_unchosen_initial/2^((i-1)/lambda);
                Q(unchosen_index) = Q(unchosen_index)+ alpha_70_omitted_pos_unchosen*PE_u;
            ...
            % else if feedback is presented and feedback is negative
                ...
                alpha_70_presented_neg_unchosen = alpha_70_presented_neg_unchosen_initial/2^((i-1)/lambda);
                Q(unchosen_index) = Q(unchosen_index)+ alpha_70_presented_neg_unchosen*PE_u;
        ...
        elseif sub_stimuli(i) == 5 | sub_stimuli(i) == 6 % 50%
            ...
            % if fb is presented and the feedback is positive
                ...
                alpha_50_presented_pos_unchosen = alpha_50_presented_pos_unchosen_initial/2^((i-1)/lambda);
                Q(unchosen_index) = Q(unchosen_index) + alpha_50_presented_pos_unchosen*PE_u;
            ...
            % else if feedback is omitted and feedback is negative
                ...
                alpha_50_omitted_neg_unchosen = alpha_50_omitted_neg_unchosen_initial/2^((i-1)/lambda);
                Q(unchosen_index) = Q(unchosen_index) + alpha_50_omitted_neg_unchosen*PE_u;
            ...
            % else if feedback is omitted and feedback is positive
                ...
                alpha_50_omitted_pos_unchosen = alpha_50_omitted_pos_unchosen_initial/2^((i-1)/lambda);
                Q(unchosen_index) = Q(unchosen_index)+ alpha_50_omitted_pos_unchosen*PE_u;
            ...
            % else if feedback is presented and feedback is negative
                ...
                alpha_50_presented_neg_unchosen = alpha_50_presented_neg_unchosen_initial/2^((i-1)/lambda);
                Q(unchosen_index) = Q(unchosen_index)+ alpha_50_presented_neg_unchosen*PE_u;
