% Model 7b: Fit rl model with two learning rates per stimulus reward 
% probabilities (i.e. a total of 6 learning rates) separately for valence
% and update of chosen and unchosen action value
...
for i = 1:nsubs
    ...
    for j = 1:niter
        ...
        [params, LL] = fmincon(@probfb_fun_model7b,params,[],[],[],[],LB,UB,[],options,......
