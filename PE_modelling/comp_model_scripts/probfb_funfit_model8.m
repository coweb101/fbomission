% Model 8: Fit rl model with separate learning rates for stimulus reward 
% probabilities and feedback appearance 
...
for i = 1:nsubs
    ...
    for j = 1:niter
        ...
        [params, LL] = fmincon(@probfb_fun_model8,params,[],[],[],[],LB,UB,[],options,......
