function error = probfb_fun_model7c(params,sub_choice,sub_fb,sub_not_choice,ntrials, sub_stimuli)

% Separate learning rates for FB valence, reward probability, and choice
...
alpha_90_pos_unchosen = params(7);
alpha_70_pos_unchosen = params(8);
alpha_50_pos_unchosen = params(9);
alpha_90_neg_unchosen = params(10);
alpha_70_neg_unchosen = params(11);
alpha_50_neg_unchosen = params(12);
beta = params(13);
    ...
    if isnan(sub_choice(i)) || isnan(sub_fb(i))
        ...
        if sub_stimuli(i) == 1 | sub_stimuli(i) == 2 % if current stimulus is 90%
            ...
            if sub_fb(i)==1 % and if fb is positive
             ...
             Q(unchosen_index) = Q(unchosen_index) + alpha_90_pos_unchosen*PE_u;
        
            elseif sub_fb(i)==0 % if fb is negative
                
                Q(chosen_index) = Q(chosen_index) + alpha_90_neg*PE_c;
             Q(unchosen_index) = Q(unchosen_index) + alpha_90_neg_unchosen*PE_u;
        ...
        elseif sub_stimuli(i) == 3 | sub_stimuli(i) == 4 % 70%
            ...
            if sub_fb(i)==1 % and if fb is positive
             ...
             Q(unchosen_index) = Q(unchosen_index) + alpha_70_pos_unchosen*PE_u;
        
            elseif sub_fb(i)==0 % if fb is negative
                
                Q(chosen_index) = Q(chosen_index) + alpha_70_neg*PE_c;
                 Q(unchosen_index) = Q(unchosen_index) + alpha_70_neg_unchosen*PE_u;
        ...
        elseif sub_stimuli(i) == 5 | sub_stimuli(i) == 6 % 50%
            if sub_fb(i)==1 % and if fb is positive
                ...
                Q(chosen_index) = Q(chosen_index) + alpha_50_pos*PE_c;
                 Q(unchosen_index) = Q(unchosen_index) + alpha_50_pos_unchosen*PE_u;
        
            
            elseif sub_fb(i)==0 % if fb is negative
                
                Q(chosen_index) = Q(chosen_index) + alpha_50_neg*PE_c;
                 Q(unchosen_index) = Q(unchosen_index) + alpha_50_neg_unchosen*PE_u;
