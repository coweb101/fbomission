function error = probfb_fun_model6b(params,sub_choice,sub_fb,sub_not_choice,ntrials, sub_stimuli)

% separate learning rates for action/stimulus reward probability
