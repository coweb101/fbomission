function error = probfb_fun_model1b(params,sub_choice,sub_fb,sub_not_choice,ntrials, sub_stimuli)

% one global learning rate, update of chosen and unchosen action
...
for i = 1:ntrials
    ...
    if isnan(sub_choice(i)) || isnan(sub_fb(i))
        ...
        Q(unchosen_index) = Q(unchosen_index) + alpha*PE_u;
