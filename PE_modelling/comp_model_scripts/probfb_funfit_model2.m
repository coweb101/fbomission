% Model 2: Fit model with two learning rates (sep. for pos/neg FB) & an 
% exploration parameter; only updates of chosen action value
...
for i = 1:nsubs
    ...
    for j = 1:niter
        ...
        [params, LL] = fmincon(@probfb_fun_model2,params,[],[],[],[],LB,UB,[],options,......
