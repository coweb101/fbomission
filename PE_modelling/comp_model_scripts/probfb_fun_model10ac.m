function error = probfb_fun_model10ac(params,sub_choice,sub_fb,sub_not_choice,ntrials, sub_stimuli, sub_feedback_type)

% Separate learning rates for valence + reward probability + appearance 
% + RL-PH dynamic + unchosen update
    ...
    if isnan(sub_choice(i)) || isnan(sub_fb(i))
        ...
        if sub_stimuli(i) == 1 | sub_stimuli(i) == 2 % if current stimulus is 90%
            ...
            if sub_feedback_type(i) == 1 & sub_fb(i) == 1 
                ...
                Q(unchosen_index) = Q(unchosen_index) + kappa*alpha_90_presented_pos*PE_u;
            ...
            % else if feedback is omitted and feedback is negative
                ...
                Q(unchosen_index) = Q(unchosen_index) + kappa*alpha_90_omitted_neg*PE_u;
            ...
            % else if feedback is omitted and feedback is positive
                ...
                Q(unchosen_index) = Q(unchosen_index)+ kappa*alpha_90_omitted_pos*PE_u;
            ...
            % else if feedback is presented and feedback is negative
                ...
                Q(unchosen_index) = Q(unchosen_index)+ kappa*alpha_90_presented_neg*PE_u;
        ...
        elseif sub_stimuli(i) == 3 | sub_stimuli(i) == 4 % 70%
            ...
            if sub_feedback_type(i) == 1 & sub_fb(i) == 1 
                ...
                Q(unchosen_index) = Q(unchosen_index) + kappa*alpha_70_presented_pos*PE_u;
            ...
            % else if feedback is omitted and feedback is negative
                ...
                Q(unchosen_index) = Q(unchosen_index) + kappa*alpha_70_omitted_neg*PE_u;
            ...
            % else if feedback is omitted and feedback is positive
                ...
                Q(unchosen_index) = Q(unchosen_index)+ kappa*alpha_70_omitted_pos*PE_u;
            ...
            % else if feedback is presented and feedback is negative
                ...
                Q(unchosen_index) = Q(unchosen_index)+ kappa*alpha_70_presented_neg*PE_u;
        ...
        elseif sub_stimuli(i) == 5 | sub_stimuli(i) == 6 % 50%
            ...
            if sub_feedback_type(i) == 1 & sub_fb(i) == 1 
                ...
                Q(unchosen_index) = Q(unchosen_index) + kappa*alpha_50_presented_pos*PE_u;
            ...
            % else if feedback is omitted and feedback is negative
                ...
                Q(unchosen_index) = Q(unchosen_index) + kappa*alpha_50_omitted_neg*PE_u;
            ...
            % else if feedback is omitted and feedback is positive
                ...
                Q(unchosen_index) = Q(unchosen_index)+ kappa*alpha_50_omitted_pos*PE_u;
            ...
            % else if feedback is presented and feedback is negative
                ...
                Q(unchosen_index) = Q(unchosen_index)+ kappa*alpha_50_presented_neg*PE_u;
