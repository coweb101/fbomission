function error = probfb_fun_model3c(params,sub_choice,sub_fb,sub_not_choice,ntrials, sub_stimuli, sub_feedback_type)

% Separate learning rates for presented and omitted FB and chosen and
% unchosen action (+ update of unchosen action)

% set parameters
alpha_presented = params(1);
alpha_omitted = params(2);
alpha_presented_unchosen = params(3);
alpha_omitted_unchosen = params(4);
beta = params(5);
...
for i = 1:ntrials
    ...
    if isnan(sub_choice(i)) || isnan(sub_fb(i))
        ...
        if sub_feedback_type(i) == 1 % if fb is presented
            ...
            Q(unchosen_index) = Q(unchosen_index) + alpha_presented_unchosen*PE_u;
        ...
        elseif sub_feedback_type(i) == 0 % if fb is omitted
            ...
            Q(unchosen_index) = Q(unchosen_index) + alpha_omitted_unchosen*PE_u;
