% Model 10ac: Fit rl model with separate learning rates for valence + 
% reward probability + appearance
...
% lower and upper bound for fit (alpha,beta, kappa, eta)
...
for i = 1:nsubs
    ...
    for j = 1:niter
        ...
        [params, LL] = fmincon(@probfb_fun_model10ac,params,[],[],[],[],LB,UB,[],options,......
