% Model 9b: Fit rl model with separate learning rates for stimulus reward 
% probabilities and context + update of chosen and unchosen
...
for i = 1:nsubs
    ...
    for j = 1:niter
        ...
        [params, LL] = fmincon(@probfb_fun_model9b,params,[],[],[],[],LB,UB,[],options,......
