% Model 4b: Fit rl model with two global learning rate across all 6 stimuli 
% and across feedback valence and presence, however separately for the get
% reward and avoid loss context
...
for i = 1:nsubs
    ...
    for j = 1:niter
        ...
        params = [alpha_rewardcontext, alpha_losscontext, beta];
        ...
        [params, LL] = fmincon(@probfb_fun_model4b,params,[],[],[],[],LB,UB,[],options,......
